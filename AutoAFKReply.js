...
module.exports = (() => {
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        return class AutoAFKReply extends Plugin {
            ...
            setupAutoAFK() {
                // Automatically enable AFK after 5 minutes of inactivity if the feature is enabled
                if (this.autoAFK) {
            ...
            resetInactivityTimer() {
                ...
                // Set a new 5-minute timer to activate AFK mode
            ...
            patchMessages() {
                try {
                    ...
                    Dispatcher.subscribe("MESSAGE_CREATE", (event) => {
                        ...
                        // Only respond if AFK mode is active, and ignore messages that came before AFK was activated
            ...
            getSettingsPanel() {
                ...
                toggleAFKButton.addEventListener("click", () => {
                    this.afk = !this.afk;
                    this.lastMessageTimestamp = this.afk ? new Date().getTime() : null; // Track when AFK mode is activated
